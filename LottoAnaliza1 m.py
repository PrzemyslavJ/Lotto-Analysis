...
option = 1 # 1 = chybil trafil, 2 = plaszczyzny fana
comb_list = list(combinations(range(1, 43), 5))
start_index = comb_list.index((1, 2, 3, 4, 5))
counter = 0
optionName = ""
...
most_balls_matched = [0 for i in range(0,6)]
winning_tickets = [0 for i in range(0,40)]
    ...
    for ticket in tickets:
        ...
        if matches > 2:
            ...
            if matches == 3:
                ...
                this_prize_total += 500
            elif matches == 5:
                this_prize_total += 250000
